...
class YoloV5InteractiveViewer(ttk.Frame):
    ...
    def load_model(self, filename: str):
        ...
        self.right_sidebar.load_model_button.set_filename(os.path.basename(filename))
    ...
    def load_mask(self, filename: str):
        ...
        self.right_sidebar.load_mask_button.set_filename(os.path.basename(filename))
...
class RightSidebar(ttk.Frame):
    ...
    def __init__(self, root: YoloV5InteractiveViewer):
        ...
        self.load_model_button = LoadFileButton(
            model_config, "Load model", command=self.load_model
        )
        ...
        self.load_mask_button = LoadFileButton(
            mask_config_frame, "Load mask", command=self.load_mask
        )
